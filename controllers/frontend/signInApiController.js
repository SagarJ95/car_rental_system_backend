...
const SignUp = catchAsync(async (req, res) => {
    ...
    try {
        ...
        if (creation) {
            ...
            await sequelize.query(`INSERT INTO users_logs (user_id, login_in, token, created_at) VALUES (:user_id, :login_in, :token,:created_at)`, {
...
const Login = catchAsync(async (req, res) => {
    ...
    try {
        ...
        let checkEmailExits = await db.query(`Select * from users where email = $1`, [email]);
...
export { SignUp, Login };
//# sourceMappingURL=signInApiController.js.map